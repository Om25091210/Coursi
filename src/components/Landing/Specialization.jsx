...
const Specialization = () => {
  return (
    ...
    <div className='flex flex-col gap-3 items-center justify-center'>
            ...
            <span className='h-24 w-px bg-purple-gradient'></span>
            <div className='max-w-3xl flex flex-col justify-center items-center mb-3'>
                <span className='inline-flex rounded-full text-white w-10 h-10 font-bold items-center justify-center mb-3 bg-purple-gradient-1'>
                2
                </span>
                <h3 className='text-3xl m-0 font-bold bg-purple-gradient-text'>Learn</h3>
            </div>
            <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14 px-4">
                <h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Specialization Tracks</h2>
                <p className="mt-1 text-gray-600 dark:text-gray-400">A personalized and adaptable program that caters to learners of all expertise levels - beginner, intermediate, or advanced.</p>
            </div>
            </div>
        </div>
