...
<div className="max-w-[85rem] px-4 pb-10 sm:px-6 lg:px-8 lg:pb-14 mx-auto">
  <div className="relative p-6 md:p-16">
    <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
      ...
      <h3 className="text-lg font-semibold dark:text-white text-blue-600">About CourSi Academy</h3>

        <h2 className="mt-5 md:mt-10 text-2xl text-gray-800 font-bold sm:text-3xl dark:text-gray-200">
